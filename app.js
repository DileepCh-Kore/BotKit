...
server.start();
// JWTapp.listen(botConfig.server.port+1, (err) =>{
//     if(err)
//         console.log("EXpress api err",err)
//     console.log('app running on port',botConfig.server.port)
// });
...
sdk.registerBot(require('./generateJWT'))
